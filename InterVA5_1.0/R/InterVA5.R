...
#* @param output "classic": The same delimited output format as InterVA5; or "extended": deliminated output followed by full distribution of cause of death proability.
